...
st.markdown("\n")
ANALYSIS RESULTS
Findings : {st.session_state.report_data['findings']}
...
if st.session_state.show_report and st.session_state.report_data:
        ...
        with col_r1:
            ...
            <div class="metric-card">
                ...
                <p><strong>Patient ID:</strong> {st.session_state.report_data['patient_id']}</p>
        ...
        with col_r2:
            ...
            <div class="metric-card">
                ...
                <p><strong>Clinical Findings:</strong> {st.session_state.report_data['findings']}</p>
